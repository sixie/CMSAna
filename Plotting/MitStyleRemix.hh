...
//  MITStyle->SetPadBottomMargin(0.13);
  MITStyle->SetPadBottomMargin(0.14); 
  MITStyle->SetPadTopMargin   (0.08);
//  MITStyle->SetPadTopMargin   (0.14);
//  MITStyle->SetPadLeftMargin  (0.15);
  MITStyle->SetPadLeftMargin  (0.16); 
...
//  MITStyle->SetMarkerSize (0.4);
  MITStyle->SetMarkerSize (1.0); 

  MITStyle->SetTitleSize(0.06);
