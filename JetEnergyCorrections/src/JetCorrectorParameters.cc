...
// $Id: JetCorrectorParameters.cc,v 1.1 2013/06/13 16:27:22 sixie Exp $
//
// Generic parameters for Jet corrections
//
#include "CMSAna/JetEnergyCorrections/interface/JetCorrectorParameters.h"
#include "CMSAna/JetEnergyCorrections/src/Utilities.cc"
#include <iostream>
#include <iomanip>
#include <fstream>
#include <sstream>
...
JetCorrectorParameters::JetCorrectorParameters(const std::string& fFile, const std::string& fSection) 
{
  ...
  if (!input.is_open()) {
    std::cout << "\n****************************************************************************\n";
    std::cout << "Error: Input file " << fFile << " cannot be opened.\n";
    std::cout << "****************************************************************************\n\n";
    assert(false);
  }
