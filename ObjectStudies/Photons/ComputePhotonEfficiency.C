...
// Simple Example
//
//root -l CMSAna/ObjectStudies/Photons/ComputePhotonEfficiency.C+'("/afs/cern.ch/work/s/sixie/public/Phase2Upgrade/PhotonEfficiency/ntuples/PhotonEfficiencyNtuple.diphjets-START53_V7A.root",22,-1,"PromptPhoton")'
//
...
void ComputePhotonEfficiency(const string inputfile, int type = 0, int option = -1, string label = "") {
  ...
  //*****************************************************************************************
  TH1F *histDenominatorPt = new TH1F ("histDenominatorPt",";Photon p_{T} [GeV/c]; Number of Events", 50, 0 , 100);
  TH1F *histNumeratorPt = new TH1F ("histNumeratorPt",";Photon p_{T} [GeV/c]; Number of Events", 50, 0 , 100);
  ...
  TH1F *histDenominatorRho = new TH1F ("histDenominatorRho",";Photon Rho; Number of Events", 50, 0 , 100);
  TH1F *histNumeratorRho = new TH1F ("histNumeratorRho",";Photon Rho; Number of Events", 50, 0 , 100);
  TH1F *histDenominatorNpv = new TH1F ("histDenominatorNpv",";Photon Npv; Number of Events", 50, 0 , 100);
  TH1F *histNumeratorNpv = new TH1F ("histNumeratorNpv",";Photon Npv; Number of Events", 50, 0 , 100);
  TH1F *histDenominatorNpu = new TH1F ("histDenominatorNpu",";Photon Npu; Number of Events", 50, 0 , 100);
  TH1F *histNumeratorNpu = new TH1F ("histNumeratorNpu",";Photon Npu; Number of Events", 50, 0 , 100);

  TH2F *histDenominatorPtEta = new TH2F ("histDenominatorPtEta",";Photon p_{T} [GeV/c] ; Photon #eta; Number of Events", 50, 0 , 100, 50, -3.0, 3.0);
  TH2F *histNumeratorPtEta = new TH2F ("histNumeratorPtEta",";Photon p_{T} [GeV/c] ; Photon #eta; Number of Events", 50, 0 , 100, 50, -3.0, 3.0);
  ...
  TGraphAsymmErrors *efficiency_phi = cmsana::createEfficiencyGraph(histNumeratorPhi, histDenominatorPhi, "Efficiency_Phi" , vector<double>() ,  -99., -99., 0., 1., false);
  ...
  TGraphAsymmErrors *efficiency_npu = cmsana::createEfficiencyGraph(histNumeratorNpu, histDenominatorNpu, "Efficiency_Npu" , vector<double>() ,  -99., -99., 0., 1., false);  
  ...
  // Output
  //==============================================================================================================
  TFile *file = TFile::Open(("PhotonEfficiency"+Label+".root").c_str(), "UPDATE");
  file->cd();
