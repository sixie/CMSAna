...
foreach file(`cat /afs/cern.ch/work/s/sixie/public/releases/analysis/CMSSW_5_3_9_patch3/src/CMSAna/HHToBBGG/catalog/diphjets-START53_V7A.txt`)
  echo $file " " $i
  bsub -q 1nd -o /afs/cern.ch/user/s/sixie/work/private/condor/res/Phase2Upgrade/PhotonTrees_diphjets-START53_V7A_${i}.out -J Phase2Upgrade_PhotonTrees_diphjets-START53_V7A_${i} /afs/cern.ch/work/s/sixie/public/condor/bin/runRootJob_upgrade.csh /afs/cern.ch/user/s/sixie/CMSSW_upgrade/src/CMSAna/ObjectStudies/ MakePhotonNtupleFromMC.C +\(\"root://eoscms//eos/cms/${file}\",\"PhotonNtuple.diphjets-START53_V7A.${i}.root\",true\) PhotonNtuple.diphjets-START53_V7A.${i}.root /afs/cern.ch/work/s/sixie/public/Phase2Upgrade/PhotonStudies/ntuples/jobs/
  @ i = $i + 1
end
...
foreach file(`cat /afs/cern.ch/work/s/sixie/public/releases/analysis/CMSSW_5_3_9_patch3/src/CMSAna/ObjectStudies/catalog/DiPhotonBoxPt25To250Age0_STAR17_61_V1A.txt`)
  echo $file " " $i
  bsub -q 1nd -o /afs/cern.ch/user/s/sixie/work/private/condor/res/Phase2Upgrade/PhotonTrees_DiPhotonBoxPt25To250Age0_STAR17_61_V1A_${i}.out -J Phase2Upgrade_PhotonTrees_DiPhotonBoxPt25To250Age0_STAR17_61_V1A_${i} /afs/cern.ch/work/s/sixie/public/condor/bin/runRootJob_upgrade.csh /afs/cern.ch/user/s/sixie/CMSSW_upgrade/src/CMSAna/ObjectStudies/ MakePhotonNtupleFromMC.C +\(\"root://eoscms//eos/cms/${file}\",\"PhotonNtuple.DiPhotonBoxPt25To250Age0.${i}.root\",true\) PhotonNtuple.DiPhotonBoxPt25To250Age0.${i}.root /afs/cern.ch/work/s/sixie/public/Phase2Upgrade/PhotonStudies/ntuples/jobs/
  @ i = $i + 1
end
...
foreach file(`cat /afs/cern.ch/work/s/sixie/public/releases/analysis/CMSSW_5_3_9_patch3/src/CMSAna/ObjectStudies/catalog/WZHgg-125-Age0DES_DES17_61_V5.txt `)
  echo $file " " $i
  bsub -q 1nd -o /afs/cern.ch/user/s/sixie/work/private/condor/res/Phase2Upgrade/PhotonTrees_WZHgg-125-Age0DES_DES17_61_V5.txt_${i}.out -J Phase2Upgrade_PhotonTrees_WZHgg-125-Age0DES_DES17_61_V5.txt_${i} /afs/cern.ch/work/s/sixie/public/condor/bin/runRootJob_upgrade.csh /afs/cern.ch/user/s/sixie/CMSSW_upgrade/src/CMSAna/ObjectStudies/ MakePhotonNtupleFromMC.C +\(\"root://eoscms//eos/cms/${file}\",\"PhotonNtuple.WZHgg-125-Age0DES_DES17_61_V5.${i}.root\",true\) PhotonNtuple.WZHgg-125-Age0DES_DES17_61_V5.${i}.root /afs/cern.ch/work/s/sixie/public/Phase2Upgrade/PhotonStudies/ntuples/jobs/
  @ i = $i + 1
end
...
foreach file(`cat /afs/cern.ch/work/s/sixie/public/releases/analysis/CMSSW_5_3_9_patch3/src/CMSAna/HHToBBGG/catalog/qcd_pt50To80-START53_V7A.txt`)
  echo $file " " $i
  bsub -q 1nd -o /afs/cern.ch/user/s/sixie/work/private/condor/res/Phase2Upgrade/PhotonTrees_qcd_pt50To80-START53_V7A_${i}.out -J Phase2Upgrade_PhotonTrees_qcd_pt50To80-START53_V7A_${i} /afs/cern.ch/work/s/sixie/public/condor/bin/runRootJob_upgrade.csh /afs/cern.ch/user/s/sixie/CMSSW_upgrade/src/CMSAna/ObjectStudies/ MakePhotonNtupleFromMC.C +\(\"root://eoscms//eos/cms/${file}\",\"PhotonNtupleFake.qcd_pt50To80-START53_V7A.${i}.root\",false\) PhotonNtupleFake.qcd_pt50To80-START53_V7A.${i}.root /afs/cern.ch/work/s/sixie/public/Phase2Upgrade/PhotonStudies/ntuples/jobs/
  @ i = $i + 1
end
...
foreach file(`cat /afs/cern.ch/work/s/sixie/public/releases/analysis/CMSSW_5_3_9_patch3/src/CMSAna/HHToBBGG/catalog/qcd_pt80To120-START53_V7A.txt`)
  echo $file " " $i
  bsub -q 1nd -o /afs/cern.ch/user/s/sixie/work/private/condor/res/Phase2Upgrade/PhotonTrees_qcd_pt80To120-START53_V7A_${i}.out -J Phase2Upgrade_PhotonTrees_qcd_pt80To120-START53_V7A_${i} /afs/cern.ch/work/s/sixie/public/condor/bin/runRootJob_upgrade.csh /afs/cern.ch/user/s/sixie/CMSSW_upgrade/src/CMSAna/ObjectStudies/ MakePhotonNtupleFromMC.C +\(\"root://eoscms//eos/cms/${file}\",\"PhotonNtupleFake.qcd_pt80To120-START53_V7A.${i}.root\",false\) PhotonNtupleFake.qcd_pt80To120-START53_V7A.${i}.root /afs/cern.ch/work/s/sixie/public/Phase2Upgrade/PhotonStudies/ntuples/jobs/
  @ i = $i + 1
end
