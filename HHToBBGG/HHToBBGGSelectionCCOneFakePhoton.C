...
//
//root -l -b -q  CMSAna/HHToBBGG/HHToBBGGSelectionCCOneFakePhoton.C+'("root://eoscms//eos/cms/store/user/sixie/BACON/V00-00-02/HHtoBBGG-14tev-START53_V7A/BACONNtuple.dihiggs-bbgg-14tev.1.root","HHToBBGG.root",1)'
//root -l -b -q  CMSAna/HHToBBGG/HHToBBGGSelectionCCOneFakePhoton.C+'("root://eoscms//eos/cms/store/user/sixie/BACON/V00-00-00/ttHgg-125-START53_V7A/BACONNtuple_1_1_CaY.root","ttH.root",2)'
//root -l -b -q  CMSAna/HHToBBGG/HHToBBGGSelectionCCOneFakePhoton.C+'("BACONNtuple.root","test.root",0)'
//
