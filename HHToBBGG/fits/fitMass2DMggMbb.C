...
//     fitResultBjetPhoWin = modelBjetPhoWin.fitTo(*pseudoDataBjetPhoWin, RooFit::Save(), RooFit::Extended(kTRUE), RooFit::Strategy(2));
    ...
    */
    ...
    cout << "\nFit Results\n";
    cout << "NSig: " << nsigPho.getVal() << " +/- " << nsigPho.getPropagatedError(*fitResult2D) << "\n";
    cout << "NResBkg: " << nresPho.getVal() << " +/- " << nresPho.getPropagatedError(*fitResult2D) << "\n";
    cout << "NNonResBkg: " << nnonresPho.getVal() << " +/- " << nnonresPho.getPropagatedError(*fitResult2D) << "\n";
    cout << "\n";
