...
void FitScenariosTwoD_BkgReducedByFactorOfTwo(const string inputfilePho = "/afs/cern.ch/work/d/daan/public/releases/CMSSW_5_3_9_patch3/src/CMSAna/HHToBBGG/data/HHToBBGG_SignalBkgd_AfterCuts_diphotonMass.root", const string inputfileBjet = "/afs/cern.ch/work/d/daan/public/releases/CMSSW_5_3_9_patch3/src/CMSAna/HHToBBGG/data/HHToBBGG_SignalBkgd_AfterCuts_dibjetMass.root", const string inputfileTwoD = "/afs/cern.ch/work/d/daan/public/releases/CMSSW_5_3_9_patch3/src/CMSAna/HHToBBGG/data/HHToBBGG_SignalBkgd_AfterCuts_twoDMass.root", const string scanOption = "lum", Int_t NToys = 500, Int_t s = 5) {
  ...
  TFile *f = new TFile(Form(("CMSAna/HHToBBGG/data/MassFitResults/ResolutionAnalysis/OptionB_BkgReducedByFactorOfTwo/"+scanOption+"FitScenario%d.root").c_str(), s), "RECREATE");
...
//     resSigmaBjet.setVal(resSigmaBjet.getVal()*(20./14.31));
  ...
  if (scanOption == "pho") {
    cout << "Pho Energy Resolution Scan : " << s << " : " << sigSigmaPho.getVal() << " * " << phoResolution[s] << " = " << sigSigmaPho.getVal()*phoResolution[s] << "\n";
