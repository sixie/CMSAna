...
//
//root -l -b -q  CMSAna/HHToBBGG/HHToBBGGSelectionBBFakePhotons.C+'("root://eoscms//eos/cms/store/user/sixie/BACON/V00-00-02/HHtoBBGG-14tev-START53_V7A/BACONNtuple.dihiggs-bbgg-14tev.1.root","HHToBBGG.root",1)'
//root -l -b -q  CMSAna/HHToBBGG/HHToBBGGSelectionBBFakePhotons.C+'("root://eoscms//eos/cms/store/user/sixie/BACON/V00-00-00/ttHgg-125-START53_V7A/BACONNtuple_1_1_CaY.root","bbgg.root",2)'
//root -l -b -q  CMSAna/HHToBBGG/HHToBBGGSelectionBBFakePhotons.C+'("BACONNtuple.root","test.root",0)'
//
...
void HHToBBGGSelectionBBFakePhotons(const string inputfile,          // input file
...
//       cout << "GenJet " << gen << " : " << genJ->pt << " " << genJ->eta << " " << genJ->phi << " " << genJ->matchedPdgId << "\n";
    ...
    // Discount all events with any real photons
